  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] text-center px-4 py-16">
      <h1 className="text-5xl md:text-7xl font-bold mb-6 animate-fade-in">
        ...
        <span className="bg-gradient-to-r from-[rgb(53,145,181)] to-[rgb(56,209,120)] bg-clip-text text-transparent">
          Beautifully
        </span>
      </h1>
      ...
      <div className="flex flex-wrap gap-4 mb-16 animate-fade-in justify-center">
        <Link to="/upload">
          <Button 
            size="lg" 
            className="text-lg px-8 py-6 rounded-xl bg-gradient-to-r from-[rgb(53,145,181)] to-[rgb(56,209,120)] hover:opacity-90 transition-opacity border-0 shadow-lg"
          >
